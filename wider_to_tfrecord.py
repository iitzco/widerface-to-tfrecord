...
flags = tf.app.flags
flags.DEFINE_string('output_path', 'output/val.tfrecord', 'Path to output TFRecord')
FLAGS = flags.FLAGS
...
def parse_example(f):
  ...
  print(filename)
  # filepath_b = os.path.join(b"../face/WIDER_train/images/", filename.encode('utf-8'))
  filepath = os.path.join("../face/WIDER_val/images/", filename)
  print(filepath)
...
def main(unused_argv):
  f = open("../face/wider_face_split/wider_face_val_bbx_gt.txt")
